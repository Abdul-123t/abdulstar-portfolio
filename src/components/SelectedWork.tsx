          ...
          <div className="pt-16 border-t border-neutral-900 space-y-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {CLIENT_BUSINESS_WORK.map((biz) => (
                <div
                  key={biz.id}
                  className="bg-[#121212] border border-neutral-800/90 p-5 sm:p-6 flex flex-col justify-between space-y-6 hover:border-neutral-600 transition-colors group"
                >
                  <div className="space-y-3">
                    <div className="flex items-center justify-between gap-2">
                      <span className="font-mono text-[10px] text-neutral-500 uppercase tracking-wider bg-black/60 px-2 py-0.5 border border-neutral-800 flex items-center gap-1.5 truncate max-w-[220px] sm:max-w-none">
                    ...
                    <h4 className="font-heading font-bold text-lg sm:text-xl text-white tracking-wide group-hover:text-neutral-200">
                      {biz.name}
                    </h4>
                    ...
                    <div className="pt-3 border-t border-neutral-800/80 flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                      ...
                      {biz.googleProfileUrl && (
                        <a
                          ...
                          className="w-full sm:flex-1 inline-flex items-center justify-center gap-1.5 px-3 py-2.5 sm:py-2 bg-neutral-900 hover:bg-neutral-800 border border-neutral-700 hover:border-neutral-500 text-white font-mono text-[10px] sm:text-[11px] font-bold uppercase tracking-wider transition-all duration-200 group/btn"
                        >
                          <MapPin className="w-3 h-3 text-blue-400 shrink-0" />
                          <span>View Google Profile</span>
                          <ExternalLink className="w-2.5 h-2.5 opacity-60 group-hover/btn:opacity-100 transition-opacity shrink-0" />
                        </a>
                      )}
                      ...
                      {biz.liveUrl && (
                        <a
                          ...
                          rel="noopener noreferrer"
                          id={`website-${biz.id}`}
                          className="w-full sm:w-auto inline-flex items-center justify-center gap-1.5 px-3 py-2.5 sm:py-2 border border-neutral-800 hover:border-neutral-600 text-neutral-300 hover:text-white font-mono text-[10px] sm:text-[11px] font-bold uppercase tracking-wider transition-all duration-200"
                          title="Visit website"
                        >
